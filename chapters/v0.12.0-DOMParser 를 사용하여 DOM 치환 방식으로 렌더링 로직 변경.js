 ...
 * 2023.10.15
 *
 * Change componentId to containerId
 * Change innerHTML to DOMParser
 *
 **/
  ...
  target.modules.forEach((value, key) => {
    ...
    components = components.replace(
      ...
      (origin, attributes, slot) => {
        ...
        // Convert a component tag event into a native event
...
class BaseComponent {
  ...
  render() {
    ...
    if (element) {
      element.parentNode.replaceChild(parseDOM(template), element);
      return '';
    }
