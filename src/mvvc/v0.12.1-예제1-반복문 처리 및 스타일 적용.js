  ...
  template() {
    return (
      `<div id="container" style="border:2px solid #f0f">
        ...
        <button-event :count="${this.count}" @increase="increaseHandler" @decrease="decreaseHandler">slot contents</button-event>
        <button-event :count="${this.count}" @increase="increaseHandler" @decrease="decreaseHandler">slot contents</button-event>
        <method-event v-if="${this.count === 0}" style="background-color: #00f"></method-event>
        <method-event v-esle-if="${this.count === 1}" style="background-color: #00b"></method-event>
        <method-event v-else style="background-color: #00c"></method-event>
        <method-event :image="https://upload.wikimedia.org/wikipedia/commons/1/10/Marvel_Studios_2016_logo.svg" @methodEvent="methodEventHandler"></method-event>
      </div>`
    );
  }
}
